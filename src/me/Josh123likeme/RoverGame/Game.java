...
import me.Josh123likeme.RoverGame.UI.UIManager;
...
public class Game extends Canvas implements Runnable {
	...
	public Game() {
		...
		body.setMediumEquipment(0, new MEDIUM_BATTERY(rover));
		
		rover = new Rover(body, null);
		
		new Window(INITIAL_WIDTH, INITIAL_HEIGHT, "Rover Game", this);
